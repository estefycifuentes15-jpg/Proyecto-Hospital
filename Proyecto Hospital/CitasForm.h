...
namespace ProyectoHospital {
	...
	/// <summary>
	/// Resumen de CitasForm
	/// </summary>
	public ref class CitasForm : public System::Windows::Forms::Form
	{
	public:
		CitasForm(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(CitasForm::typeid));
			...
			this->label1->Location = System::Drawing::Point(208, 87);
			...
			// dateTimePicker1
			// 
			this->dateTimePicker1->Location = System::Drawing::Point(440, 12);
			...
			this->tableLayoutPanel2->Location = System::Drawing::Point(71, 137);
			...
			this->Siguiente->Location = System::Drawing::Point(597, 393);
			...
			this->Siguiente->Click += gcnew System::EventHandler(this, &CitasForm::Siguiente_Click);
			// 
			// pictureBox1
			// 
			...
			this->ClientSize = System::Drawing::Size(692, 433);
			...
			this->Name = L"CitasForm";
			this->Text = L"CitasForm";
			this->Load += gcnew System::EventHandler(this, &CitasForm::CitasForm_Load);
...
#pragma endregion
	private: System::Void CitasForm_Load(System::Object^ sender, System::EventArgs^ e) {
	}
	private: System::Void Siguiente_Click(System::Object^ sender, System::EventArgs^ e) {
		// Abrir la pantalla de Consulta y manejar el resultado
		ConsultaForm^ f = gcnew ConsultaForm();
		this->Hide();
		System::Windows::Forms::DialogResult res = f->ShowDialog();
		if (res == System::Windows::Forms::DialogResult::OK) {
			// Propagar OK para que el llamador (menu) pueda reaccionar
